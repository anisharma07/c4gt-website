...
This directory contains comprehensive tests generated by Claude AI for the c4gt-website project.
The tests are designed to provide good coverage and catch real bugs in your application.

## 🧪 Generated Test Files

- `socialcalctouch.test.js` - Application tests
- `json2.test.js` - Application tests
- `jquery.flot.threshold.multiple.test.js` - Application tests
- `highslide.test.js` - Application tests
- `test-setup.js` - Application tests
- `jest.config.js` - Application tests
- `fileMock.js` - Application tests
